...
public interface LancamentoHoraRepository extends JpaRepository<LancamentoHora, Long> {
    ...
    @Query("SELECT lh FROM LancamentoHora lh WHERE MONTH(lh.dataRegistro) = MONTH(CURRENT_DATE) AND YEAR(lh.dataRegistro) = YEAR(CURRENT_DATE) AND lh.usuario.ativo = true AND lh.atividade.ativo = true AND lh.atividade.projeto.ativo = true")
    List<LancamentoHora> findLancamentosMesAtual();

    @Query("SELECT lh FROM LancamentoHora lh WHERE MONTH(lh.dataRegistro) = MONTH(CURRENT_DATE) AND YEAR(lh.dataRegistro) = YEAR(CURRENT_DATE) AND lh.usuario.id = :usuarioId AND lh.usuario.ativo = true  AND lh.atividade.ativo = true AND lh.atividade.projeto.ativo = true")
    List<LancamentoHora> findLancamentosMesAtualByUsuarioId(Long usuarioId);

    @Query("SELECT lh FROM LancamentoHora lh WHERE WEEK(lh.dataRegistro) = WEEK(CURRENT_DATE) AND YEAR(lh.dataRegistro) = YEAR(CURRENT_DATE) AND MONTH(lh.dataRegistro) = MONTH(CURRENT_DATE) AND lh.usuario.ativo = true AND lh.atividade.ativo = true AND lh.atividade.projeto.ativo = true")
    List<LancamentoHora> findLancamentosSemanaAtual();

    @Query("SELECT lh FROM LancamentoHora lh WHERE WEEK(lh.dataRegistro) = WEEK(CURRENT_DATE) AND YEAR(lh.dataRegistro) = YEAR(CURRENT_DATE) AND MONTH(lh.dataRegistro) = MONTH(CURRENT_DATE) AND lh.usuario.id = :usuarioId AND lh.usuario.ativo = true AND lh.atividade.ativo = true AND lh.atividade.projeto.ativo = true")
    List<LancamentoHora> findLancamentosSemanaAtualByUsuarioId(Long usuarioId);

    @Query("SELECT lh FROM LancamentoHora lh WHERE DAY(lh.dataRegistro) = DAY(CURRENT_DATE) AND YEAR(lh.dataRegistro) = YEAR(CURRENT_DATE) AND MONTH(lh.dataRegistro) = MONTH(CURRENT_DATE) AND lh.usuario.ativo = true AND lh.atividade.ativo = true AND lh.atividade.projeto.ativo = true")
    List<LancamentoHora> findLancamentosDiaAtual();

    @Query("SELECT lh FROM LancamentoHora lh WHERE DAY(lh.dataRegistro) = DAY(CURRENT_DATE) AND YEAR(lh.dataRegistro) = YEAR(CURRENT_DATE) AND MONTH(lh.dataRegistro) = MONTH(CURRENT_DATE) AND lh.usuario.id = :usuarioId AND lh.usuario.ativo = true AND lh.atividade.ativo = true AND lh.atividade.projeto.ativo = true")
